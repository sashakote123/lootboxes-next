...
const ItemImage: React.FC<Props> = ({ item, width=79, height=79 }) => {
    return (
        <div className={styles.image}>
            <Image className={styles.rarity} width={width} height={height} src={rarityImages[item.rarity]} alt='rare' />
            <Image priority={false} className={styles.item} width={width} height={height} src={item.image} alt='img' />
        </div>
